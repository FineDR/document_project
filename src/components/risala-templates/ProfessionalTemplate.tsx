...
const ProfessionalTemplate: React.FC<ProfessionalTemplateProps> = ({ isPreview }) => {
  ...
  return (
    ...
    >
      ...
      <header className="text-center mb-16">
        ...
        <div className="mt-6 h-1 w-32 mx-auto bg-redMain rounded-full shadow-sm"></div>
      </header>

      {/* GUEST & ORGANIZATION */}
      <section className="grid grid-cols-1 md:grid-cols-2 gap-10 mb-14 text-sm">
        <div className="p-6 bg-gray-100 dark:bg-gray-800 rounded-lg shadow-md border-l-4 border-primary">
      ...
      <section className="space-y-8 mb-14 text-sm leading-relaxed">
        {raw_data.purpose_statement && (
          <div className="p-6 bg-redMain/5 rounded-lg shadow-inner border-l-4 border-redMain">
